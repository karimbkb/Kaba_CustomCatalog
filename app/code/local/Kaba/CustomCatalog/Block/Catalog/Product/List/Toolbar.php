 ...
 */
class Kaba_CustomCatalog_Block_Catalog_Product_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('customcatalog/catalog/product/list/toolbar.phtml');
    }
